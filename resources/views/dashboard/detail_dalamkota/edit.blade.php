...
@section('container')
    ...
    <h2>Edit Data</h1>
        <form action="/dashboard/dalam_kota/{{ $data->id }}" method="post">
            @csrf
            @method('PUT')
            <div class="form-floating">
                <select name="kategori_acara" onchange="ganti_kategori()" class="form-select" id="floatingSelect"
                    ...
                    <option <?php if ($data->kategori_acara == '1') {
    echo 'selected';
} ?> value="1">Dalam Kota Acara Resmi</option>
                    <option <?php if ($data->kategori_acara == '2') {
    echo 'selected';
} ?> value="2">Dalam Kota Acara Tidak Resmi</option>
            ...
            <div class="satu">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="name" value="{{ $data->nama }}" name="nama" class="form-control"
                            placeholder="Masukkan Judul Acara" id="name">
                    </div>
                    <div class="col">    
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" value="{{ $data->jml_dinas }}" name="jml_dinas" class="form-control"
                            placeholder="Jumlah Dinas" aria-label="Masukkan Jumlah Dinas">
                    </div>
                    <div class="col">
                        <label for="text" class="form-label">Masukkan Jumlah Yang Dinas</label>
                        <input type="text" value="{{ $data->jml_yangdinas }}" name="jml_yangdinas" class="form-control"
                            placeholder="Jumlah Yang Dinas" aria-label="Masukkan Jumlah Yang Dinas">
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" value="{{ $data->nilai }}" name="nilai" class="form-control"
                            placeholder="Nilai Dinas" aria-label="Nilai Dinas">
                    </div>
                    <div class="col">
                        <label for="text" class="form-label">Administrasi Setelah Dinas</label>
                        <input type="text" value="{{ $data->admin }}" name="admin" class="form-control"
                            placeholder="Administrasi Setelah Dinas" aria-label="Administrasi Setelah Dinas">
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <label for="text" class="form-label">Titik Acara</label>
                        <input type="text" value="{{ $data->titik_acara }}" name="titik_acara" class="form-control"
                            placeholder="Titik Acara" aria-label="Titik Acara">
                    </div>
                    <div class="col">
                        <label for="text" class="form-label">Tingkat Kesulitan Acara</label>
                        <input type="text" value="{{ $data->kesulitan }}" name="kesulitan" class="form-control"
                            placeholder="Titik Kesulitan Acara" aria-label="Titik Kesulitan Acara">
                    </div>
                </div>
            </div>
