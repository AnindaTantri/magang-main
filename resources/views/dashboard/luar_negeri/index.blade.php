...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      <a class="nav-link {{ Request::is('data_penugasan') ? 'active' : ''}}" aria-current="page" 
            href="/dashboard/detail_luarnegeri">
      ...
      <table class="table table-hover text-nowrap" id="datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="/dashboard/luar_negeri/{{$tampilkan->id}}/edit" class="btn btn-outline-warning" ><span data-feather="edit"></a>
                                    <form action="/dashboard/luar_negeri/{{$tampilkan->id}}" method="POST">
                                        @csrf
                                        {{ method_field('DELETE') }}
